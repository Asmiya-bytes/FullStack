...
app.get('/', (req, res) => {
  res.send(`
    ...
    <head>
      ...
      <style>
        body { font-family: Arial, sans-serif; max-width: 400px; margin: 60px auto; background: #80b9f3; }
        ...
        button { width: 100%; padding: 12px; background: #64c967; color: white; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; }
        button:hover { background: #50c956; }
